...
mkdir stanford-ner
cp stanford-ner-2015-04-20/stanford-ner.jar stanford-ner/stanford-ner.jar
cp stanford-ner-2015-04-20/classifiers/english.all.3class.distsim.crf.ser.gz stanford-ner/english.all.3class.distsim.crf.ser.gz
cp stanford-ner-2015-04-20/classifiers/english.all.3class.distsim.prop stanford-ner/english.all.3class.distsim.prop

echo " . . . Clearing all"
rm -rf stanford-ner-2015-04-20 stanford-ner-2015-04-20.zip
